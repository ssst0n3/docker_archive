...
* dqd: 
    * ssst0n3/docker_archive:containerd-v1.6.19 -> ssst0n3/docker_archive:containerd-v1.6.19_v0.1.0
    * ssst0n3/docker_archive:containerd-v1.6.19_v0.1.0
* ctr:
    * ssst0n3/docker_archive:ctr_containerd-v1.6.19 -> ssst0n3/docker_archive:ctr_containerd-v1.6.19_v0.1.0
    * ssst0n3/docker_archive:ctr_containerd-v1.6.19_v0.1.0
...
go: go1.17.10
libseccomp: 2.5.4
root@containerd-1-6-19:~# ctr i pull docker.io/library/busybox:latest
...
elapsed: 10.6s                                                                    total:  2.1 Mi (204.9 KiB/s)                                     
unpacking linux/amd64 sha256:e3652a00a2fabd16ce889f0aa32c38eec347b997e73bd09e69c962ec7f8732ee...
done: 139.025105ms	
root@containerd-1-6-19:~# ctr run docker.io/library/busybox:latest ctr id
...
Linux containerd-1-6-19 5.15.0-161-generic #171-Ubuntu SMP Sat Oct 11 08:17:01 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux
```

## build

```shell
make all DIR=containerd/v1.6.19
```

for developers:

```dockerfile
FROM ssst0n3/docker_archive:ctr_containerd-v1.6.19_v0.1.0
```
