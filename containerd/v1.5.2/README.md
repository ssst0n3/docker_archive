...
* dqd: 
    * ssst0n3/docker_archive:containerd-v1.5.2 -> ssst0n3/docker_archive:containerd-v1.5.2_v0.1.0
    * ssst0n3/docker_archive:containerd-v1.5.2_v0.1.0
* ctr:
    * ssst0n3/docker_archive:ctr_containerd-v1.5.2 -> ssst0n3/docker_archive:ctr_containerd-v1.5.2_v0.1.0
    * ssst0n3/docker_archive:ctr_containerd-v1.5.2_v0.1.0
...
go: go1.14.15
libseccomp: 2.5.1
root@containerd-1-5-2:~# ctr i pull docker.io/library/ubuntu:16.04
...
root@containerd-1-5-2:~# ctr run docker.io/library/ubuntu:16.04 ctr id
...
```shell
make all DIR=containerd/v1.5.2
```

for developers:

```dockerfile
FROM ssst0n3/docker_archive:ctr_containerd-v1.5.2_v0.1.0
```
