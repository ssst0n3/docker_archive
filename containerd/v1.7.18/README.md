...
* dqd: 
    * ssst0n3/docker_archive:containerd-v1.7.18 -> ssst0n3/docker_archive:containerd-v1.7.18_v0.2.0
    * ssst0n3/docker_archive:containerd-v1.7.18_v0.2.0
    * ssst0n3/docker_archive:containerd-v1.7.18_v0.1.0
* ctr:
    * ssst0n3/docker_archive:ctr_containerd-v1.7.18 -> ssst0n3/docker_archive:ctr_containerd-v1.7.18_v0.2.0
    * ssst0n3/docker_archive:ctr_containerd-v1.7.18_v0.2.0: bump the base image
...
elapsed: 11.5s                                                                    total:  2.1 Mi (188.9 KiB/s)                                     
...
Linux containerd-1-7-18 5.15.0-161-generic #171-Ubuntu SMP Sat Oct 11 08:17:01 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux
```
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_containerd-v1.7.18_v0.2.0
```
