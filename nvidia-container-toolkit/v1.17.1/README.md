...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.1 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.1_v0.1.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.1_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.1 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.1_v0.1.0
...
```shell
$ ./ssh
root@nvidia-container-toolkit-1-17-1:~# docker run -ti --runtime=nvidia --gpus=all busybox
...
○ fake-nvidia-mknod.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Thu 2025-07-24 08:43:36 UTC; 43s ago
...
Jul 24 08:43:36 nvidia-container-toolkit-1-17-1 systemd[1]: Starting fake-nvidia-mknod.service - Create device nodes for fake nvidia driver...
Jul 24 08:43:36 nvidia-container-toolkit-1-17-1 systemd[1]: fake-nvidia-mknod.service: Deactivated successfully.
Jul 24 08:43:36 nvidia-container-toolkit-1-17-1 systemd[1]: Finished fake-nvidia-mknod.service - Create device nodes for fake nvidia driver.
...
Server:
 ...
 ID: 8c0cd521-168e-4a4e-b1cf-a18e2ec8953d
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.1_v0.1.0
```
