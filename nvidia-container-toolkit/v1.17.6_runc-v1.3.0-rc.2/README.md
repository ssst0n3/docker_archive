...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_runc-v1.3.0-rc.2 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_runc-v1.3.0-rc.2_v0.1.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_runc-v1.3.0-rc.2_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_runc-v1.3.0-rc.2 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_runc-v1.3.0-rc.2_v0.1.0
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_runc-v1.3.0-rc.2_v0.1.0

## usage

```shell
$ cd nvidia-container-toolkit/v1.17.6_runc-v1.3.0-rc.2
...
```shell
root@nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2:~# docker run -tid --runtime=nvidia --gpus=all busybox
...
a6e67495c810e9eb71dbc0ea8707dfba2d3a2957190723a6197021a3b14b8d8d
root@nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/a6e67495c810e9eb71dbc0ea8707dfba2d3a2957190723a6197021a3b14b8d8d/config.json | jq .hooks
{
  "prestart": [
    {
      ...
      "env": [
        ...
        "USER=root",
        "INVOCATION_ID=bd75356efd6c4cce90543879ce336d2b",
        "JOURNAL_STREAM=8:5105",
...
nvidia.com/gpu=all
root@nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2:~# docker run -tid --runtime=nvidia -e NVIDIA_VISIBLE_DEVICES=nvidia.com/gpu=all busybox
99014a2b300deeb4dc50168a5f6b3bcf8226cb9df81bde5ff5345440188bb8c7
root@nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/99014a2b300deeb4dc50168a5f6b3bcf8226cb9df81bde5ff5345440188bb8c7/config.json | jq .hooks
{
  "createContainer": [
    {
...
○ fake-nvidia-device.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Mon 2025-08-04 16:32:49 UTC; 1min 49s ago
    Process: 682 ExecStart=/usr/local/bin/fake-nvidia-device.sh (code=exited, status=0/SUCCESS)
   Main PID: 682 (code=exited, status=0/SUCCESS)
        CPU: 7ms

Aug 04 16:32:49 nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2 systemd[1]: Starting fake-nvidia-device.service - Create device nodes for fake nvidia driver...
Aug 04 16:32:49 nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2 systemd[1]: fake-nvidia-device.service: Deactivated successfully.
Aug 04 16:32:49 nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2 systemd[1]: Finished fake-nvidia-device.service - Create device nodes for fake nvidia driver.
```
...
root@nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2:~# docker info
...
Server:
 ...
 runc version: v1.3.0-rc.2-0-g159c67f8
 ...
 Name: nvidia-container-toolkit-1-17-6-runc-1-3-0-rc-2
 ID: 7ea8df59-99d0-40f5-ab01-d4364763c752
...
```shell
make all DIR=nvidia-container-toolkit/v1.17.6_runc-v1.3.0-rc.2
```

for developers:

```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_runc-v1.3.0-rc.2_v0.1.0
```
