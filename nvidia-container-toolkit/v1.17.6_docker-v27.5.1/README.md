...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_docker-v27.5.1 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.3.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.2.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_docker-v27.5.1 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.9.0
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.9.0: install real nvidia driver without kernel module; install i386 libs; bump fake-nvidia to v0.7.2
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.3.0: bump fake-nvidia to v0.7.1
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.2.0: CDI compatible
...
a5547eafb53658c3a8229d56987fc26cc9f0aa65c3efe4fecb60242b8c29fe2c
root@nvidia-container-toolkit-1-17-6-docker-27-5-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/a5547eafb53658c3a8229d56987fc26cc9f0aa65c3efe4fecb60242b8c29fe2c/config.json | jq .hooks
{
  "prestart": [
    {
...
6b9a760caab2466d8e2a6db4396cd8b74b11954d9f68ff0a1b331fa41ad698a4
root@nvidia-container-toolkit-1-17-6-docker-27-5-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/6b9a760caab2466d8e2a6db4396cd8b74b11954d9f68ff0a1b331fa41ad698a4/config.json | jq .hooks
{
  "prestart": [
    {
      "path": "/proc/433/exe",
...
lrwxrwxrwx 1 root root  43 Jul 30 07:52 /usr/lib/x86_64-linux-gnu/libnvidia-ml.so -> /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.1
lrwxrwxrwx 1 root root  51 Jul 30 07:52 /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.1 -> /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.575.57.08
-rwxr-xr-x 1 root root 22K Jul 30 07:52 /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.575.57.08
...
○ fake-nvidia-device.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Wed 2025-07-30 08:15:44 UTC; 6min ago
    Process: 630 ExecStart=/usr/local/bin/fake-nvidia-device.sh (code=exited, status=0/SUCCESS)
   Main PID: 630 (code=exited, status=0/SUCCESS)
        CPU: 6ms

Jul 30 08:15:44 nvidia-container-toolkit-1-17-6-docker-27-5-1 systemd[1]: Starting fake-nvidia-device.service - Create device nodes for fake nvidia driver...
Jul 30 08:15:44 nvidia-container-toolkit-1-17-6-docker-27-5-1 systemd[1]: fake-nvidia-device.service: Deactivated successfully.
Jul 30 08:15:44 nvidia-container-toolkit-1-17-6-docker-27-5-1 systemd[1]: Finished fake-nvidia-device.service - Create device nodes for fake nvidia driver.
```
...
Server:
 ...
 ID: b6d1f3d6-5ca4-4da5-8b95-63e6d9679c84
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.6_docker-v27.5.1_v0.9.0
```
