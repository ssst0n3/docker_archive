...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.16.1 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.16.1_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.16.1_v0.9.0
...
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.16.1 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.16.1_v0.9.0
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.16.1_v0.9.0: install real nvidia driver without kernel module; install i386 libs; bump fake-nvidia to v0.7.2
...
78647339dade326ca1db3ba0be29355a3e03b8723da4d13ea21ebc79cf6df3f5
root@nvidia-container-toolkit-1-16-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/78647339dade326ca1db3ba0be29355a3e03b8723da4d13ea21ebc79cf6df3f5/config.json | jq .hooks
{
  "prestart": [
    {
      ...
      "env": [
        ...
        "USER=root",
        "INVOCATION_ID=e42d264aa9e34ecfb2563472110fc3aa",
        "JOURNAL_STREAM=8:5421",
    ...
    },
    {
      ...
      "env": [
        "TRACEPARENT=00-9bf7fac14887d94f8ba9faeab7bd1819-7fad06e0a63d871a-01"
      ]
    }
  ]
}
...
f36634cacd461a7c15162cf09790719936c6f1fd1e197efc60abda1a3b9adf6a
root@nvidia-container-toolkit-1-16-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/f36634cacd461a7c15162cf09790719936c6f1fd1e197efc60abda1a3b9adf6a/config.json | jq .hooks
{
  "prestart": [
    {
      "path": "/proc/434/exe",
      ...
      "env": [
        "TRACEPARENT=00-9686e19ebca64d84fc948aa399170208-b75c9cb66e344de7-01"
      ]
    }
  ],
  "createContainer": [
...
○ fake-nvidia-device.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Thu 2025-07-31 03:26:14 UTC; 3min 28s ago
    Process: 656 ExecStart=/usr/local/bin/fake-nvidia-device.sh (code=exited, status=0/SUCCESS)
   Main PID: 656 (code=exited, status=0/SUCCESS)
        CPU: 6ms

Jul 31 03:26:14 nvidia-container-toolkit-1-16-1 systemd[1]: Starting fake-nvidia-device.service - Create device nodes for fake nvidia driver...
Jul 31 03:26:14 nvidia-container-toolkit-1-16-1 systemd[1]: fake-nvidia-device.service: Deactivated successfully.
Jul 31 03:26:14 nvidia-container-toolkit-1-16-1 systemd[1]: Finished fake-nvidia-device.service - Create device nodes for fake nvidia driver.
```
...
Server:
 ...
 ID: b5930b89-00c4-44d6-828a-bfc29a182a84
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.16.1_v0.9.0
```
