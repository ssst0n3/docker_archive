...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.2 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.2_v0.1.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.2_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.2 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.2_v0.1.0
...
```shell
$ ./ssh
root@nvidia-container-toolkit-1-17-0-rc-2:~# docker run -ti --runtime=nvidia --gpus=all busybox
...
○ fake-nvidia-mknod.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Thu 2025-07-24 08:22:08 UTC; 3min 15s ago
    Process: 623 ExecStart=/usr/local/bin/fake-nvidia-mknod.sh (code=exited, status=0/SUCCESS)
   Main PID: 623 (code=exited, status=0/SUCCESS)
        CPU: 7ms

Jul 24 08:22:08 nvidia-container-toolkit-1-17-0-rc-2 systemd[1]: Starting fake-nvidia-mknod.service - Create device nodes for fake nvidia driver...
Jul 24 08:22:08 nvidia-container-toolkit-1-17-0-rc-2 systemd[1]: fake-nvidia-mknod.service: Deactivated successfully.
Jul 24 08:22:08 nvidia-container-toolkit-1-17-0-rc-2 systemd[1]: Finished fake-nvidia-mknod.service - Create device nodes for fake nvidia driver.
...
Server:
 ...
 ID: 172e50a6-7c3d-4011-8cb4-f659d679c14c
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.2_v0.1.0
```
