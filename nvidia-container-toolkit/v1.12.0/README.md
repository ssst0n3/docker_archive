...
f9832d0ef47664721bedf41a5f11f08c4838817d07a80da73b73e3ba7cdbaa2a
root@nvidia-container-toolkit-1-12-0:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/f9832d0ef47664721bedf41a5f11f08c4838817d07a80da73b73e3ba7cdbaa2a/config.json | jq .hooks
{
  "prestart": [
    {
...
6dc031c8eaf91dd799c5452f5985d0ff9e0f12c9b86453d66ca181e6de944a52
root@nvidia-container-toolkit-1-12-0:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/6dc031c8eaf91dd799c5452f5985d0ff9e0f12c9b86453d66ca181e6de944a52/config.json | jq .hooks
{
  "prestart": [
    {
      "path": "/proc/310/exe",
...
root@nvidia-container-toolkit-1-12-0:~# ls -lah /usr/local/lib/libnvidia-ml.so.1
-rwxr-xr-x 1 root root 22K Jul 25 15:14 /usr/local/lib/libnvidia-ml.so.1
root@nvidia-container-toolkit-1-12-0:~# systemctl status fake-nvidia-mknod
○ fake-nvidia-mknod.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Fri 2025-07-25 15:26:20 UTC; 4min 2s ago
    Process: 430 ExecStart=/usr/local/bin/fake-nvidia-mknod.sh (code=exited, status=0/SUCCESS)
   Main PID: 430 (code=exited, status=0/SUCCESS)
        CPU: 13ms

Jul 25 15:26:20 nvidia-container-toolkit-1-12-0 systemd[1]: Starting Create device nodes for fake nvidia driver...
Jul 25 15:26:20 nvidia-container-toolkit-1-12-0 systemd[1]: fake-nvidia-mknod.service: Deactivated successfully.
Jul 25 15:26:20 nvidia-container-toolkit-1-12-0 systemd[1]: Finished Create device nodes for fake nvidia driver.
```
