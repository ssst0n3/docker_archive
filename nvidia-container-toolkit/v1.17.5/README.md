...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.5 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.5_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.5_v0.9.0
...
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.5 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.5_v0.9.0
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.5_v0.9.0: install real nvidia driver without kernel module; install i386 libs; bump fake-nvidia to v0.7.2
...
71dee909183d689e1658607462d42a2ab9468d0cf98687bd237a41a4e05d0386
root@nvidia-container-toolkit-1-17-5:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/71dee909183d689e1658607462d42a2ab9468d0cf98687bd237a41a4e05d0386/config.json | jq .hooks
{
  "prestart": [
    {
      ...
      "env": [
        ...
        "USER=root",
        "INVOCATION_ID=6c5990a9014a4ec48f1f0d96d9bf24ec",
...
b5a4b4d5816590739178e304c1b45dc261e154d7c8db8029c7a88144f7328d68
root@nvidia-container-toolkit-1-17-5:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/b5a4b4d5816590739178e304c1b45dc261e154d7c8db8029c7a88144f7328d68/config.json | jq .hooks
{
  "createContainer": [
    {
...
lrwxrwxrwx 1 root root  43 Jul 31 07:21 /usr/lib/x86_64-linux-gnu/libnvidia-ml.so -> /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.1
lrwxrwxrwx 1 root root  51 Jul 31 07:21 /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.1 -> /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.575.57.08
-rwxr-xr-x 1 root root 22K Jul 31 07:21 /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.575.57.08
...
○ fake-nvidia-device.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Thu 2025-07-31 07:42:38 UTC; 8min ago
    Process: 634 ExecStart=/usr/local/bin/fake-nvidia-device.sh (code=exited, status=0/SUCCESS)
   Main PID: 634 (code=exited, status=0/SUCCESS)
        CPU: 7ms

Jul 31 07:42:38 nvidia-container-toolkit-1-17-5 systemd[1]: Starting fake-nvidia-device.service - Create device nodes for fake nvidia driver...
Jul 31 07:42:38 nvidia-container-toolkit-1-17-5 systemd[1]: fake-nvidia-device.service: Deactivated successfully.
Jul 31 07:42:38 nvidia-container-toolkit-1-17-5 systemd[1]: Finished fake-nvidia-device.service - Create device nodes for fake nvidia driver.
```
...
coClient: Docker Engine - Community
 Version:    28.0.1
 Context:    default
 Debug Mode: false
 Plugins:
...
Server:
 ...
 ID: 513a4506-83ab-45b8-86d9-7a21f86a35f5
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.5_v0.9.0
```
