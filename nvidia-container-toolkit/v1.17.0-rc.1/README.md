...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1_v0.3.0
...
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.3.0
...
2ba43b4456c708bb7f84e1776f02c3533d7aef9abf6fb2c2d4ed265c4310fd60
root@nvidia-container-toolkit-1-17-0-rc-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/2ba43b4456c708bb7f84e1776f02c3533d7aef9abf6fb2c2d4ed265c4310fd60/config.json | jq .hooks
{
  "prestart": [
    {
...
490ba67923caa46833b8cc16a5657543f11f4bf79de67d945b4386ba954c5595
root@nvidia-container-toolkit-1-17-0-rc-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/490ba67923caa46833b8cc16a5657543f11f4bf79de67d945b4386ba954c5595/config.json | jq .hooks
{
  "prestart": [
    {
      "path": "/proc/433/exe",
...
root@nvidia-container-toolkit-1-17-0-rc-1:~# ls -lah /usr/local/lib/libnvidia-ml.so.1
-rwxr-xr-x 1 root root 22K Jul 25 08:28 /usr/local/lib/libnvidia-ml.so.1
root@nvidia-container-toolkit-1-17-0-rc-1:~# systemctl status fake-nvidia-mknod
○ fake-nvidia-mknod.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Fri 2025-07-25 09:36:13 UTC; 1min 51s ago
...
Jul 25 09:36:13 nvidia-container-toolkit-1-17-0-rc-1 systemd[1]: Starting fake-nvidia-mknod.service - Create device nodes for fake nvidia driver...
Jul 25 09:36:13 nvidia-container-toolkit-1-17-0-rc-1 systemd[1]: fake-nvidia-mknod.service: Deactivated successfully.
Jul 25 09:36:13 nvidia-container-toolkit-1-17-0-rc-1 systemd[1]: Finished fake-nvidia-mknod.service - Create device nodes for fake nvidia driver.
```
...
Server:
 ...
 ID: 2e1ead44-d5a1-4325-9c5c-285eaaa016ed
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.3.0
```
