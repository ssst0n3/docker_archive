...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1_v0.2.0
...
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.2.0
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.2.0
```
