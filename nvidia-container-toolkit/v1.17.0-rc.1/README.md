...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1_v0.3.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1_v0.2.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.0-rc.1_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.9.0
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.9.0: install real nvidia driver without kernel module; install i386 libs; bump fake-nvidia to v0.7.2
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.3.0: bump fake-nvidia to v0.7.1
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.2.0: CDI compatible
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.1.0
...
2cb4f8e2a8b46049d742b20950b5f8abb143f381d147eb87d385bcbb4a35c0b1
root@nvidia-container-toolkit-1-17-0-rc-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/2cb4f8e2a8b46049d742b20950b5f8abb143f381d147eb87d385bcbb4a35c0b1/config.json | jq .hooks
{
  "prestart": [
    {
      ...
      "env": [
        ...
        "USER=root",
        "INVOCATION_ID=db510f8b7ede4fe2a803303406dd7c0f",
        "JOURNAL_STREAM=8:6302",
    ...
    },
    {
      ...
      "env": [
        "TRACEPARENT=00-1241120349cda1780a7fba190f9a0044-ed71360073a70eb1-01"
      ]
    }
  ]
}
...
8e5b4f040259ed8545449b6e209dcfd204ecc9e07948544c498342fb02cd172b
root@nvidia-container-toolkit-1-17-0-rc-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/8e5b4f040259ed8545449b6e209dcfd204ecc9e07948544c498342fb02cd172b/config.json | jq .hooks
{
  "prestart": [
    {
      "path": "/proc/433/exe",
      ...
      "env": [
        "TRACEPARENT=00-902bc1c4a195ab9ff0aa09e39669cd28-64a15f3cff776447-01"
      ]
    }
  ],
  "createContainer": [
...
○ fake-nvidia-device.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Thu 2025-07-31 06:36:33 UTC; 4min 0s ago
...
Jul 31 06:36:33 nvidia-container-toolkit-1-17-0-rc-1 systemd[1]: Starting fake-nvidia-device.service - Create device nodes for fake nvidia driver...
Jul 31 06:36:33 nvidia-container-toolkit-1-17-0-rc-1 systemd[1]: fake-nvidia-device.service: Deactivated successfully.
Jul 31 06:36:33 nvidia-container-toolkit-1-17-0-rc-1 systemd[1]: Finished fake-nvidia-device.service - Create device nodes for fake nvidia driver.
```
...
root@nvidia-container-toolkit-1-17-0-rc-1:~# docker info
...
Server:
 ...
 Name: nvidia-container-toolkit-1-17-0-rc-1
 ID: 6269eb52-ca47-45ee-8b93-6986caf40616
...
```shell
make all DIR=nvidia-container-toolkit/v1.17.0-rc.1
```

for developers:

```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.0-rc.1_v0.9.0
```
