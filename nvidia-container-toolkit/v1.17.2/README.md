...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2_v0.3.0
...
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2_v0.3.0
...
04d14f90d22416e87c29ba7cb09b60572b8c5c69e165e1e01b23861409bbc240
root@nvidia-container-toolkit-1-17-2:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/04d14f90d22416e87c29ba7cb09b60572b8c5c69e165e1e01b23861409bbc240/config.json | jq .hooks
{
  "prestart": [
    {
      ...
      "env": [
        ...
        "USER=root",
        "INVOCATION_ID=49c65042c2ef4a369328b9b3fcece8e0",
        "JOURNAL_STREAM=8:6183",
    ...
    },
    {
      ...
      "env": [
        "TRACEPARENT=00-a50e256ed2c07594e310ba2dd9ca6c5e-a7727ba53b0e97e8-01"
      ]
    }
  ]
}
...
ffa261c0203d5ea0d603efbc711479ced77f6b54a906e678b605f551e1b818de
root@nvidia-container-toolkit-1-17-2:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/ffa261c0203d5ea0d603efbc711479ced77f6b54a906e678b605f551e1b818de/config.json | jq .hooks
{
  "prestart": [
    {
      "path": "/proc/432/exe",
      ...
      "env": [
        "TRACEPARENT=00-e304039cd7b681415647d51f45d9338e-28dc3841129acfe9-01"
      ]
    }
  ],
  "createContainer": [
...
○ fake-nvidia-mknod.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Fri 2025-07-25 08:47:50 UTC; 2min 32s ago
...
Jul 25 08:47:50 nvidia-container-toolkit-1-17-2 systemd[1]: Starting fake-nvidia-mknod.service - Create device nodes for fake nvidia driver...
Jul 25 08:47:50 nvidia-container-toolkit-1-17-2 systemd[1]: fake-nvidia-mknod.service: Deactivated successfully.
Jul 25 08:47:50 nvidia-container-toolkit-1-17-2 systemd[1]: Finished fake-nvidia-mknod.service - Create device nodes for fake nvidia driver.
```
...
Server:
 ...
 ID: a7aa5194-b045-4080-b7d6-d514ef6988c6
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2_v0.3.0
```
