...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2_v0.9.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2_v0.3.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2_v0.2.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.17.2_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2_v0.9.0
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2_v0.9.0: install real nvidia driver without kernel module; install i386 libs; bump fake-nvidia to v0.7.2
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2_v0.3.0: bump fake-nvidia to v0.7.1
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2_v0.2.0: CDI compatible
...
143625acc6badf8881065b877f142ef19f4f2289d7bec063eeeec39115cac8c8
root@nvidia-container-toolkit-1-17-2:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/143625acc6badf8881065b877f142ef19f4f2289d7bec063eeeec39115cac8c8/config.json | jq .hooks
{
  "prestart": [
    {
      ...
      "env": [
        ...
        "USER=root",
        "INVOCATION_ID=6a43defc760e4c05947c7b4dac14c152",
        "JOURNAL_STREAM=8:4911",
    ...
    },
    {
      ...
      "env": [
        "TRACEPARENT=00-d374e588d3f00f9df0d94a0a9100ac25-18729f05fe752554-01"
      ]
    }
  ]
}
...
fe07a41f4d58e20c386502f902d549eb0c3b8e47f7eb0ed72b14bb96204ec6f4
root@nvidia-container-toolkit-1-17-2:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/fe07a41f4d58e20c386502f902d549eb0c3b8e47f7eb0ed72b14bb96204ec6f4/config.json | jq .hooks
{
  "prestart": [
    {
      "path": "/proc/434/exe",
      ...
      "env": [
        "TRACEPARENT=00-e9af83d1c0ff3a62fb736b620c63271f-e4a2bc2a91327591-01"
      ]
    }
  ],
  "createContainer": [
...
○ fake-nvidia-device.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Thu 2025-07-31 07:21:15 UTC; 2min 59s ago
...
Jul 31 07:21:15 nvidia-container-toolkit-1-17-2 systemd[1]: Starting fake-nvidia-device.service - Create device nodes for fake nvidia driver...
Jul 31 07:21:15 nvidia-container-toolkit-1-17-2 systemd[1]: fake-nvidia-device.service: Deactivated successfully.
Jul 31 07:21:15 nvidia-container-toolkit-1-17-2 systemd[1]: Finished fake-nvidia-device.service - Create device nodes for fake nvidia driver.
```
...
Server:
 ...
 ID: 0028bae8-6318-4ef1-a426-f7e6a3a9640d
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.17.2_v0.9.0
```
