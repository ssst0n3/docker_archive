...
* dqd:
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.16.2 -> ssst0n3/docker_archive:nvidia-container-toolkit-v1.16.2_v0.1.0
  * ssst0n3/docker_archive:nvidia-container-toolkit-v1.16.2_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.16.2 -> ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.16.2_v0.1.0
...
```shell
$ ./ssh
root@nvidia-container-toolkit-1-16-2:~# docker run -ti --runtime=nvidia --gpus=all busybox
...
○ fake-nvidia-mknod.service - Create device nodes for fake nvidia driver
     ...
     Active: inactive (dead) since Thu 2025-07-24 07:55:50 UTC; 59s ago
...
Jul 24 07:55:50 nvidia-container-toolkit-1-16-2 systemd[1]: Starting fake-nvidia-mknod.service - Create device nodes for fake nvidia driver...
Jul 24 07:55:50 nvidia-container-toolkit-1-16-2 systemd[1]: fake-nvidia-mknod.service: Deactivated successfully.
Jul 24 07:55:50 nvidia-container-toolkit-1-16-2 systemd[1]: Finished fake-nvidia-mknod.service - Create device nodes for fake nvidia driver.
...
Server:
 ...
 ID: 79803393-b8cb-4f42-b71f-4f0e9922db4a
...
```dockerfile
FROM ssst0n3/docker_archive:ctr_nvidia-container-toolkit-v1.16.2_v0.1.0
```
