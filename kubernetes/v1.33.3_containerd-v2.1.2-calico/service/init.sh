...
log() {
  echo "[docker-archive/kubernetes/v1.33.3_containerd-v2.1.2-calico] $1" >> /dev/kmsg
}
...
install_calico_network() {
  ...
  # https://docs.tigera.io/calico/3.30/getting-started/kubernetes/helm#install-calico
