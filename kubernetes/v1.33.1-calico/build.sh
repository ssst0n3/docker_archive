...
docker buildx build --build-arg BUILDKIT_SANDBOX_HOSTNAME=kubernetes-1-33-1 --progress=plain --builder docker-archive-builder --allow security.insecure --load -t $1 .