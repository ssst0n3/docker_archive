...
# https://docs.tigera.io/archive/v3.18/getting-started/kubernetes/requirements#supported-versions
# https://docs.tigera.io/archive/v3.18/getting-started/kubernetes/quickstart#install-calico
