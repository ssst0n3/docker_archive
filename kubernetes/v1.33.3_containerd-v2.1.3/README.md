...
* dqd:
  * ssst0n3/docker_archive:kubernetes-v1.33.3_containerd-v2.1.3 -> ssst0n3/docker_archive:kubernetes-v1.33.3_containerd-v2.1.3_v0.1.0
  * ssst0n3/docker_archive:kubernetes-v1.33.3_containerd-v2.1.3_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_kubernetes-v1.33.3_containerd-v2.1.3 -> ssst0n3/docker_archive:ctr_kubernetes-v1.33.3_containerd-v2.1.3_v0.1.0
  * ssst0n3/docker_archive:ctr_kubernetes-v1.33.3_containerd-v2.1.3_v0.1.0
...
```shell
$ cd kubernetes/v1.33.3_containerd-v2.1.3
...
kube-system   coredns-674b8bbfcf-27hjs                                     0/1     Pending   0               141m
kube-system   coredns-674b8bbfcf-gkksk                                     0/1     Pending   0               141m
kube-system   etcd-kubernetes-1-33-3-containerd-2-1-3                      1/1     Running   1 (2m14s ago)   141m
kube-system   kube-apiserver-kubernetes-1-33-3-containerd-2-1-3            1/1     Running   1 (2m14s ago)   141m
kube-system   kube-controller-manager-kubernetes-1-33-3-containerd-2-1-3   1/1     Running   1 (2m14s ago)   141m
kube-system   kube-proxy-rgphh                                             1/1     Running   1 (2m14s ago)   141m
kube-system   kube-scheduler-kubernetes-1-33-3-containerd-2-1-3            1/1     Running   1 (2m14s ago)   141m
```
...
```shell
make all DIR=kubernetes/v1.33.3_containerd-v2.1.3
```
...
FROM ssst0n3/docker_archive:ctr_kubernetes-v1.33.3_containerd-v2.1.3_v0.1.0
...
