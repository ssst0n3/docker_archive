...
* dqd:
  * ssst0n3/docker_archive:kubernetes-v1.33.8 -> ssst0n3/docker_archive:kubernetes-v1.33.8_v0.1.0
  * ssst0n3/docker_archive:kubernetes-v1.33.8_v0.1.0
* ctr:
  * ssst0n3/docker_archive:ctr_kubernetes-v1.33.8 -> ssst0n3/docker_archive:ctr_kubernetes-v1.33.8_v0.1.0
  * ssst0n3/docker_archive:ctr_kubernetes-v1.33.8_v0.1.0
...
kube-system   coredns-674b8bbfcf-26cc8                    0/1     Pending   0               10m
kube-system   coredns-674b8bbfcf-l9znm                    0/1     Pending   0               10m
kube-system   etcd-kubernetes-1-33-8                      1/1     Running   1 (2m21s ago)   10m
kube-system   kube-apiserver-kubernetes-1-33-8            1/1     Running   1 (2m21s ago)   10m
kube-system   kube-controller-manager-kubernetes-1-33-8   1/1     Running   1 (2m21s ago)   10m
kube-system   kube-proxy-jzkqm                            1/1     Running   1 (2m21s ago)   10m
kube-system   kube-scheduler-kubernetes-1-33-8            1/1     Running   1 (2m21s ago)   10m
```
...
```shell
make all DIR=kubernetes/v1.33.8
```
...
FROM ssst0n3/docker_archive:ctr_kubernetes-v1.33.8_v0.1.0
...
...
RUN --mount=type=cache,id=kubernetes-v1.33.8-snapshots,target=/trick \
    cp -a /var/lib/containerd/io.containerd.snapshotter.v1.overlayfs/* /trick/
# kubeadm init under ext4 fs
RUN --mount=type=cache,id=kubernetes-v1.33.8-snapshots,target=/var/lib/containerd/io.containerd.snapshotter.v1.overlayfs \
...
RUN --mount=type=cache,id=kubernetes-v1.33.8-snapshots,target=/trick \
    ...
    rm /trick/snapshots/59/work/work/#* && \
