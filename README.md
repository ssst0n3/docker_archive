...
```
$ docker run -ti --name docker-19-03-15 ssst0n3/docker_archive:ubuntu-20.04_docker-ce-19.03.15_containerd.io-1.4.3_runc-1.0.0-rc92_v0.1.0
...
...
```
$ docker run -tid --name docker-19-03-15 ssst0n3/docker_archive:ubuntu-20.04_docker-ce-19.03.15_containerd.io-1.4.3_runc-1.0.0-rc92_v0.1.0
$ docker attach --detach-keys ctrl-x docker-19-03-15
...
Ubuntu 20.04.1 LTS ubuntu ttyS0
...
services:
  vm:
    image: ssst0n3/docker_archive:ubuntu-20.04_docker-ce-19.03.15_containerd.io-1.4.3_runc-1.0.0-rc92_v0.1.0
    ports:
        - "19315:22"
    tty: true
    stdin_open: true
EOF
$ docker compose -p docker-19-03-15 up -d
```
...
* `ubuntu-20.04_docker-ce-19.03.15_containerd.io-1.4.3_runc-1.0.0-rc92`
* `ubuntu-20.04_docker-ce-19.03.15_containerd.io-1.4.3_runc-1.0.0-rc92_v0.1.0`
