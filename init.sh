...
# kubectl create -f https://raw.githubusercontent.com/projectcalico/calico/v3.22.1/manifests/tigera-operator.yaml
# kubectl create -f https://raw.githubusercontent.com/projectcalico/calico/v3.22.1/manifests/custom-resources.yaml
